...
import static Hillchipper.Const.encryptKeyPair;
import static Hillchipper.Encrypt.privateKey;
import java.util.ArrayList;

public class Decrypt {
    static String privatKey = Const.keyPair;
    static final Integer encryptKetPair[][] = Const.decryptKeyPair;
